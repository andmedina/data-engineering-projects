...
| Project | Description |
|----|----|
| [healthcare_claims_etl](.projects/healthcare/) | End-to-end healthcare claims ETL pipeline using Python, PostgreSQL, Airflow, and analytics-ready transformations |
